...
# board's name (the board package and kernel control files, the kernel
# configuration), rewrites the name as a word inside every file,
...
# <board>-* rows of locks/upstream.lock, added by hand), and bsp.env
